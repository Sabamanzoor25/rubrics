...
on r.seat_no= e.seat_no where department='$dept' and batch='$batch'  ORDER BY project_id ";
 ...
 if(mysqli_num_rows($result) > 0)
 {
  ...
  Batch: ' .$batch.', Spring Semester ' .$year.'</th>
   </tr>
   ...
   <tr> <th colspan=7></th>
                                      ...
                                      <tr> <th colspan=7></th>
                                        ...
                                        <th colspan=5 class="border">Project Proposal</th>
  ...
  while($row = mysqli_fetch_array($result))
  {
   ...
   $output .= '
    <tr>  
                         ...
                         <td>'.$row["proposal_planI"].'</td>
                         <td>'.$row["proposal_planII"].'</td>
                         <td>'.$row["proposal_planIII"].'</td>
                         <td>'.$row["proposal_planIV"].'</td>
                         ...
                         <td>'.$row["progress_first_planI"].'</td>
                         <td>'.$row["progress_first_planII"].'</td>
                         <td>'.$row["progress_first_planIII"].'</td>
                         <td>'.$row["progress_first_planIV"].'</td>
