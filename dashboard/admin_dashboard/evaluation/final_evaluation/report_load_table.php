...
<h5 class='text-center p-2'>CS-406 Computer Engineering Project</h5>
      <h4 class='text-center p-2'>Grading of Final Report (8th/Spring Semester) (Weightage - 16%)</h4>
  ...
  <table class="table table-borderless table-striped table-earning text-center " name="cart" id="cart">
  <thead >
  <tr>
...
<th scope="row" > Weighted Average Score<br> (32)</th>
...
<th scope="row" > </th>
                    ...
                    <td class = "select2" >
                        ...
                        <td class = "select5">
                            <div class="form-group" style="padding: 10px 0px;">
                                ...
                                <select id="sum5"  class="form-control" name='s5[]' required>
                                        <option>Select Category: </option>
                                        <option value="0">0 </option>
                                <option value="25">25</option>
                                        <option value="50"> 50</option>
                        ...
                        <td class = "select6">
                            <div class="form-group" style="padding: 10px 0px;">
                                ...
                                <select id="sum6"  class="form-control" name='s6[]' required>
                                        <option>Select Category: </option>
                                        <option value="0">0 </option>
                                <option value="25">25</option>
                                        <option value="50"> 50</option>
                        ...
                        <td class = "select7">
                            <div class="form-group" style="padding: 10px 0px;">
                                ...
                                <select id="sum7"  class="form-control" name='s7[]' required>
                                        <option>Select Category: </option>
                                        <option value="0">0 </option>
                                <option value="25">25</option>
                                        <option value="50"> 50</option>
                        ...
                        <td class = "select8">
                            <div class="form-group" style="padding: 10px 0px;">
                                ...
                                <select id="sum8"  class="form-control" name='s8[]' required>
                                        <option>Select Category: </option>
                                        <option value="0">0 </option>
                                <option value="25">25</option>
                                        <option value="50"> 50</option>
      ...
      <td> <div class="form-group" style="padding: 10px 0px;">
          <div class="fxt-transformY-50 fxt-transition-delay-2">
         <input type="number" name="item_total"  id="item_total"  value="" jAutoCalc="{sum1} + {sum2} + {sum3} + {sum4} ">
     ...
     <div class=" py-2 px-4  " align="center">
      <button  class="btn btn-primary btn-lg ml-2 mt-3"  type='submit' name='report_rubric_submit' id='submit' onclick='pdf()'  >SUBMIT</button>
...
<strong> <em>[PLO-2 (%)*4+ PLO-3 (%)*8+ PLO-12 (%)*4+ PLO-7 (%)*4+PLO-8(%)*4+ PLO-10(%)*8]/100</em></strong></p>
      </div> </div> </div> </div>   
      </div>
...
function autoCalcSetup() {
  ...
  $('form#cart tr.line_items').jAutoCalc({keyEventsFire: true,  emptyAsZero: true});//decimalPlaces: 3,
