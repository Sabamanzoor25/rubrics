...
<h5 class='text-center p-2'>CS-406 Computer Engineering Project</h5>
      <h4 class='text-center p-2'>Grading of Final Report (8th/Spring Semester) (Weightage - 20%)</h4>
  ...
  <th scope="row" >Weighted Average Score<br> (40) </th>
...
<th scope="row" > </th>
     ...
     <td class = "select5">
      ...
      <td> <div class="form-group" style="padding: 10px 0px;">
          <div class="fxt-transformY-50 fxt-transition-delay-2">
         <input type="number" name="item_total"  id="item_total"  value="" jAutoCalc="{s1} + {s2} + {s3} + {s4} +{s5}">
     ...
     <div class=" py-2 px-4  " align="center">
      <button  class="btn btn-primary btn-lg ml-2 mt-3"  type='submit' name='final_evalualtion_sumbit' id='submit' onclick='pdf()'  >SUBMIT</button>
...
<strong> <em>Weighted Average Score = [PLO-10 (%)*8+ PLO-10 (%)*8+ PLO-10 (%)*8+ PLO-10 (%)*8+ PLO-10 (%)*8]/100  </em></strong></p>
      </div> </div> </div> </div>   
      </div>
