...
<input name="id" id="projectID"   value="<?php echo $row['project_id']?>">
  ...
  <!-- <table class="table table-striped"> -->
      <form  action='evaluation.php' name='proposal' method='POST' id="cart">
      <h5 class='text-center p-2'>CS-406 Computer Engineering Project</h5>
      <h4 class='text-center p-2'>Grading of Final Report (7th/Spring Semester) (Weightage - 6%)</h4>
  ...
  <th scope="row" >I<br>Problem Identification and Objectives </th>
  <th scope="row" >II<br>Relevance to SDG</th>
  <th scope="row" >III<br>Proposed Methodology</th>
  <th scope="row" >IV<br>Work Plan</th>
  <th scope="row" >Weighted Average Score </th>
...
<th scope="row" > </th>
     ...
     <div class=" py-2 px-4  " align="center">
      <button  class="btn btn-primary btn-lg ml-2 mt-3"  type='submit' name='proposal_rubric_sumbit' id='submit' onclick='pdf()'  >SUBMIT</button>
...
<strong> <em>Weighted Average Score = [PLO-2 (%)*3+ PLO-7 (%)*3+ PLO-3 (%)*3+ PLO-11 (%)*3]/100 </em></strong></p>
      </div> </div> </div> </div>   
      </div>
