...
<th scope="row" > </th>
     ...
     <div class=" py-2 px-4  " align="center">
      <button  class="btn btn-primary btn-lg ml-2 mt-3"  type='submit' name='1st_evaluation_submit' id='submit' onclick='pdf()' >SUBMIT</button>
...
<strong> <em>Weighted Average Score = [PLO-2 (%)*12+ PLO-3 (%)*12+ PLO-11 (%)*12+ PLO-10 (%)*12]/100 </em></strong></p>
      </div> </div> </div> </div>   
      </div>
