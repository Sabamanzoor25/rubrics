...
// echo $count; 
if($count > 0){
    $query="UPDATE `progress_rubric` SET `progress_first_planI`='$s1',`progress_first_planII`='$s2',`progress_first_planIII`='$s3',`progress_first_planIV`='$s4' , `progress_first_weight` = '$s5'  WHERE project_id ='$projectID' and seat_no = '$seat_no'";
    // Execute the query
    mysqli_query($conn, $query);
    if ($result == true) {
        echo '<div id="alert" class="alert alert-success">
