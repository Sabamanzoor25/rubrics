...
<div class=" p-4">
 ...
 <form method="post" action="../php/1st_semester_export.php">
...
Batch: ".$b." , Fall Semester ".$year." (Semester 1)</h3>"?>
...
<table class="table table-hover text-center table-earning">
                                      ...
                                      <tr> <th colspan=5></th>
                                        ...
                                        <th colspan=5 class='border'>Semester progress</th>
                                            ...
                                            <!-- 1st evaluation -->
                                           <th scope="row"  class="border-left">I<br>Literature Review <br> (12) </th>
