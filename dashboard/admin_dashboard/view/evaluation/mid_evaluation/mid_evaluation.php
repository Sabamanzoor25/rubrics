...
<div class="card-body">
<hr>
<h1 class="">1st Semester Evaluation</h1>
<hr>            
<!-- <nav>
...
<nav >
												<div class="nav nav-tabs" id="nav-tab" role="tablist">
													...
													<a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#progress_rubric" role="tab" aria-controls="nav-profile"
                                                     ...
                                                     <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="1st_progress_rubric/1st_progress_rubric.php" role="tab" aria-controls="nav-profile"
...
<div class="tab-content pl-3 pt-2" id="nav-tabContent">
       ...
       <div class="card px-6">
<div class="card-body">
  <hr><h2>1st Semester Progress Rubric</h2>
