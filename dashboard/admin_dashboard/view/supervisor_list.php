...
$dept=$_POST['dept'];
        ...
        $query  = "SELECT distinct supervisor, student_name, fyp_title , project_id FROM rubric where department='$dept' and batch='$batch'  ORDER BY project_id ";
...
<table class="table table-hover text-center">
                          ...
                          for($i=0; $i < sizeof($sname); $i++) {
                            ...
                            if ($arr[$supervisor]['printed'] == 'no') {
                                echo "<td   ' rowspan='".$arr[$fyp]['rowspan']."'>".$supervisor."</td>"; 
                                echo "<td   rowspan='".$arr[$fyp]['rowspan']."'>".$fyp."</td>";
