...
<div class='p-2'>
<button id='supervisor_list'   class='btn btn-primary' >Supervisor list</button>
</div>
</div>
...
$(document).ready(function(){
    $('#supervisor_list').click(function(e){
        e.preventDefault();
        $.ajax({
            method:"POST",
        url: 'supervisor_list.php',
        data:$('#supervisor_list').serialize(),
        datatype:'html',
        success: function(response){
            $('#table-data').html(response);
        }
