                    ...
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                            <h2><?php
                                            $q1="SELECT student_name from rubric where supervisor = '$_SESSION[user_Login]';";
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                            <h2><?php
                                            $q2 ="SELECT distinct(fyp_title) from rubric where supervisor = '$_SESSION[user_Login]'";
                                                $sql=mysqli_query($conn, $q2);
                                                if($sql){
                                                $row=mysqli_num_rows($sql); 
                                            if($row)
                                        echo $row;
                        ...
                        <div class="row">
                            <div class="col-lg">
                                ...
                                <!-- <form method="post" action="dashboard/php/export.php">
                                       <button type="submit" name="export"  value="Export" class="btn btn-success btn-lg ml-2  float-right">EXPORT</button>
                                       </form>
                                       <form action='dashboard/php/pdf.php' >
