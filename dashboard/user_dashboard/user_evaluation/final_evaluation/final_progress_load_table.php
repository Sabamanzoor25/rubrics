...
<h5 class='text-center p-2'>CS-406 Computer Engineering Project</h5>
      <h4 class='text-center p-2'>Grading of Final Report (8th/Spring Semester) (Weightage - 24%)</h4>
  ...
  <th scope="row" >Weighted Average Score <br> (48)</th>
...
<th scope="row" > </th>
      ...
      <td> <div class="form-group" style="padding: 10px 0px;">
          <div class="fxt-transformY-50 fxt-transition-delay-2">
         <input type="number" name="item_total"  id="item_total"  value="" jAutoCalc="{sum1} + {sum2} + {sum3} + {sum4} +{sum5}">
     ...
     <div class=" py-2 px-4  " align="center">
      <button  class="btn btn-primary btn-lg ml-2 mt-3"  type='submit' name='final_progress_sumbit' id='submit' onclick='pdf()'  >SUBMIT</button>
...
<strong> <em>Weighted Average Score = [PLO-2 (%)*16+ PLO-8 (%)*8+ PLO-9 (%)*8+ PLO-10 (%)*8+PLO-11(%)*8]/100  </em></strong></p>
      </div> </div> </div> </div>   
      </div>
